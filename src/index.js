...
function checksExistsUserAccount(request, response, next) {
  ...
  if (!user){
    return response.status(400).json({erro: "usuario nao encontrado"});
...
//retornar uma lista com todas as terefas desse usuário.
...
app.post('/todos', checksExistsUserAccount, (request, response) => {
 ...
 //aqui cria as tarefas
  ...
  //aqui elee insere dentro do user
